...
</div> <div class="prose-content space-y-4 md:space-y-6" data-astro-cid-ulloptvv> ${renderComponent($$result, "PortableText", $$PortableText, { "value": aboutData?.[0]?.description, "data-astro-cid-ulloptvv": true })} </div> </div> </div> <div class="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 pt-8 md:pt-12" data-astro-cid-ulloptvv> <div class="space-y-1.5 md:space-y-2" data-astro-cid-ulloptvv> <p class="text-[8px] md:text-[10px] font-black text-[#599692] uppercase tracking-[0.4em]" data-astro-cid-ulloptvv>Experience</p> <p class="text-xl md:text-2xl text-white font-black tabular-nums" data-astro-cid-ulloptvv>4+ Years</p> </div> <div class="space-y-1.5 md:space-y-2" data-astro-cid-ulloptvv> <p class="text-[8px] md:text-[10px] font-black text-[#626c7d] uppercase tracking-[0.4em]" data-astro-cid-ulloptvv>Delivered</p> <p class="text-xl md:text-2xl text-white font-black tabular-nums" data-astro-cid-ulloptvv>6+ Apps</p> </div> <div class="space-y-1.5 md:space-y-2" data-astro-cid-ulloptvv> <p class="text-[8px] md:text-[10px] font-black text-[#626c7d] uppercase tracking-[0.4em]" data-astro-cid-ulloptvv>Role Focus</p> <p class="text-xl md:text-2xl text-white font-black tabular-nums" data-astro-cid-ulloptvv>Full Stack</p> </div> </div> </div> </section> <!-- Services Grid (Awwwards Style) --> <section class="py-12 md:py-32" data-astro-cid-ulloptvv> <div class="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 border border-white/5 rounded-3xl md:rounded-[3rem] overflow-hidden" data-astro-cid-ulloptvv> ${[
